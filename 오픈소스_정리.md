...
* CMake로 빌드
	...
	* GLM 빌드
		...
		15) 만약 glm_static이 안보일 경우 
		    BUILD -> GLM 폴더 안에 내용을 전부 지우기 -> f) 부터 다시 해보기
		<br>
		<img src="https://user-images.githubusercontent.com/16630469/157831045-4ee53827-6960-4980-b7a6-27c7b1d807da.png" 
		width="80%" height="70%"/>
		<br><br>
		
		16) Libx64폴더에 'GLM'폴더 만들기
		17) Libx64 -> GLM에 'lib', 'include'폴더 만들기
		<br>
		<img src="https://user-images.githubusercontent.com/16630469/157831049-70b13bf6-f183-42ae-9879-ec5f40e07edf.png" 
		width="80%" height="70%"/>
		<br><br>
		
		18) BUILD -> GLM -> glm -> Release -> glm_static.lib 파일을 복사 후
		    Libx64 -> GLM -> lib 폴더 안에 붙여넣기
		19) 그 후 glm_static.lib 파일 이름을 'glm.lib'로 변경
		<br>
		<img src="https://user-images.githubusercontent.com/16630469/157831052-e9456bb3-d1b7-4f50-81ee-9db5df5462ce.png" 
		width="80%" height="70%"/>
		<br><br>

		20) SOURCE -> glm-master -> glm 폴더 안에있는 모든 파일을 복사 후
